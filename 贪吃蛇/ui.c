...
// 用来绘图的颜色
#define COLOR_SNAKE			RGB(0, 0, 139)
#define COLOR_FOOD			RGB(0, 100, 0)
#define COLOR_BOUNDARY		RGB(0, 128, 0)
#define COLOR_TEXT			RGB(0,128,128)

// 游戏的参数的设置 
#define INIT_TIMER_ELAPSE	100	// 初始的时钟周期，确定游戏初始速度
#define	ONE_LEVELS_SCORES	20	// 每升级一次需要的计分
#define INIT_SNAKE_LEN		8	// 蛇的长度
